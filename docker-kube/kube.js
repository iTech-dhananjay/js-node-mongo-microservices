/*
 1. nano deployment-test.yml : > it will create new file as name deployment-test.yml

 2. kubectl create -f deployment-test.yml   - 
           deployment.apps/rss-site created

 3. kubectl get deployments   

 4. kubectl get pods ||  kubectl get pods -o wide  (-o wide means output with more information)
